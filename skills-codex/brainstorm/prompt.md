...
4. In Codex hookless mode, inspect `.agents/ao/codex/state.json` and ensure `ao codex start` once per thread before ideation.
...
4. Leave `ao codex stop` to closeout skills; `$brainstorm` owns the startup path.
