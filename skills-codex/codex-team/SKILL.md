...
For Claude-runtime feature compatibility (agents/hooks/worktree/settings), use `references/claude-code-latest-features.md` when this skill falls back to `$swarm`.
