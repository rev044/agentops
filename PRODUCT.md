...
- **Zero Setup, Zero Telemetry** — All state lives in git-tracked `.agents/` directories with no cloud dependency, giving teams full control and auditability. 49 skills, 3 hooks, and the knowledge flywheel work independently with no external daemon.
