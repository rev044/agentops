...
author: boshu2 (via Claude Code session 4 on bushido-box)
status: proposal
...
A minimal Claude Code skill set that implements the Karpathy pattern. Canonical layout:
...
- [eugeniughelbur/obsidian-second-brain](https://github.com/eugeniughelbur/obsidian-second-brain) — richer Claude Code skill with scheduled agents + thinking tools + SOUL.md / CRITICAL_FACTS.md pattern
