...
- [../shared/references/stale-scope-validation.md](../shared/references/stale-scope-validation.md) — re-validate inherited scope estimates against HEAD before acting on deferred beads, handoff docs, or prior-session plans.
