...
- [../shared/references/stale-scope-validation.md](../shared/references/stale-scope-validation.md) — planning rule: re-validate inherited scope estimates against HEAD before acting on deferred beads or handoff docs.
