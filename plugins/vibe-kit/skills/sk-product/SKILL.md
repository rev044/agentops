...
- **sk-research**: For technical exploration first
- **sk-formulate**: When ready to decompose into engineering tasks
- **sk-plan**: Alternative for one-time plans (no reusable formula)
