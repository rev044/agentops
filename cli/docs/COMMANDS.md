...
> Auto-generated by `scripts/generate-cli-reference.sh` on 2026-02-18.
...
```
      --full      With --hooks, install all events (equivalent to ao hooks install --full)
  -h, --help      help for init
      --hooks     Also register hooks (equivalent to ao hooks install)
